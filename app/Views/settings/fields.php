...
<script>(function(){const t=document.querySelector("[data-field-type]"),o=document.querySelector("[data-options-field]");if(!t)return;const s=()=>{o.hidden=t.value!=="SELECT";};t.addEventListener("change",s);s();})();</script>
<?= $this->endSection() ?>
