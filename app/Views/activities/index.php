...
<?php if (! empty($focus)): ?><script>document.addEventListener("DOMContentLoaded",()=>{const el=document.getElementById("activity-<?= (int) $focus ?>");if(el){el.classList.add("bg-primary-50");el.scrollIntoView({block:"center"});}});</script><?php endif ?>
<?= $this->endSection() ?>
