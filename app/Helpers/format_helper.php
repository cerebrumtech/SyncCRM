...
function normalize_phone(?string $raw): ?string
{
    ...
    // This value is the duplicate-detection key, so it must never be invented from a
    // fragment. '98abc43210' strips to 7 digits, which is not a number anyone can dial
    // and could collide with an unrelated contact. No key is safer than a wrong key.
